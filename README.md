...
In this we use the following dependencies:-\
  ...
  • uuid(Univeral Unique Identifiers) --> for run-time unique id's\
  • method-override --> to use PUT/PATCH & DELETE API Request in form tag in html\
\\
To Run :-\
  **Step 1:** git clone <REPOSITORY_URL> --> cloning remote repository to your local system\
  **Step 2:** npm install --> to install all above required dependencies/packages\
